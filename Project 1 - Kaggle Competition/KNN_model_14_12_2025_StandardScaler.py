...
def main():
    ...
    # n_neighbors=457 -> quite large neighborhood so smoother decision boundary
    ...
    modelKNN = KNeighborsClassifier(n_neighbors=457, weights="distance", metric="cosine")
    ...
    submission_path = os.path.join(HOME_FOLDER, "sample_KNN_mean_pool_14_12_25_S.csv")
